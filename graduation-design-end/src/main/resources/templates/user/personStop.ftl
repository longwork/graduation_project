...
<table class="easyui-datagrid" title="已冻结账户详情表" style="width:100%;height:380px;margin-top:20px;margin-left:20px;" id="dg"
       data-options="rownumbers:true,singleSelect:true,pagination:true,iconCls:'icon-ok',url:'/person/getStopPerson',multiSort:true,toolbar:'#tb'">
    <thead>
    <tr>
